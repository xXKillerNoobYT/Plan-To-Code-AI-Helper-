...
describe('DependencyManager - hasCircularDependency', () => {
    ...
    it('should return false when there are no circular dependencies', () => {
        const tasks: Task[] = [
            ...
            { taskId: '2', title: 'Task 2', description: '', priority: 'Medium', status: 'Open', dependencies: ['1'], createdAt: new Date('2023-01-02'), updatedAt: new Date('2023-01-02') },
        ];
    ...
    it('should handle complex dependency graphs without circular dependencies', () => {
        const tasks: Task[] = [
            { taskId: '1', title: 'Task 1', description: '', priority: 'High', status: 'Open', dependencies: [], createdAt: new Date('2023-01-01'), updatedAt: new Date('2023-01-01') },
            { taskId: '2', title: 'Task 2', description: '', priority: 'Medium', status: 'Open', dependencies: ['1'], createdAt: new Date('2023-01-02'), updatedAt: new Date('2023-01-02') },
            { taskId: '3', title: 'Task 3', description: '', priority: 'Low', status: 'Open', dependencies: ['2'], createdAt: new Date('2023-01-03'), updatedAt: new Date('2023-01-03') },
        ];
